...
const getBuscarfilme = async function(id){
    ...
    if(response.status == 200){
        document.getElementById('nome').value      = dados.filmes[0].nome
        document.getElementById('sinopse').value   = dados.filmes[0].sinopse
        document.getElementById('image').value      = dados.filmes[0].image
        document.getElementById('valor').value      = dados.filmes[0].valor
